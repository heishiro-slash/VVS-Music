...
public class EmisorasTest {
     ...
     *
     * @throws java.lang.Exception Agregar un contenido a la lista de contenido
     * de una emisora
     */
    ...
    /**
     *
     * @throws Exception con una lista no vacia, agrego un contenido pasandole
     * un predecesor no valido (y no nulo)
     *
     */
    @Test(expected = ContentEmisoraNotFoundException.class)
    ...
    /**
     *
     * @throws ContentEmisoraNotFoundException Añadir un contenido a la emisora
     * y eliminarlo
     */
    @Test
     ...
     *
     * @throws ContentEmisoraNotFoundException Añadir un contenido a la emisora
     * y eliminarlo, verificando que la duracion queda correctamente modificada
     */
    @Test
    ...
    /**
     *
     * @throws Exception busca un elemento que no existe en la lista de
     * contenido
     */
    @Test(expected = TitleNotFoundException.class)
